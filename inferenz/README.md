...
Zur Datensatz Generierung wurde unter anderem das Tool unter [dateset](./../dataset/) verwendet.
...
Mit [original Clip](coreml/resources/clip640x424.mp4) sind hier Frames aus dem generierten Clip mit Bounding-Boxen:
